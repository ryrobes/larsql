...
**Location:** `dashboard/backend/app.py` lines 1665, 1681, 1954
...
2. **dashboard/frontend/src/components/SoundingsExplorer.js**
   - Lines 318-512: Reforge section component (already added earlier)

3. **dashboard/frontend/src/components/SoundingsExplorer.css**
