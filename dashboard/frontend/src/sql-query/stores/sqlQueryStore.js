  ...
  persist(
    immer((set, get) => ({
      ...
      fetchConnections: async () => {
        ...
        try {
          const res = await fetch(`${API_BASE_URL}/sql/connections`);
      ...
      fetchSchema: async (connectionName) => {
        ...
        try {
          const res = await fetch(`${API_BASE_URL}/sql/schema/${connectionName}`);
          const data = await res.json();
      ...
      fetchHistory: async (params = {}) => {
        ...
        try {
          ...
          const res = await fetch(`${API_BASE_URL}/sql/history?${queryParams}`);
          const data = await res.json();
      ...
      saveToHistory: async (entry) => {
        try {
          await fetch(`${API_BASE_URL}/sql/history`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
      ...
      deleteHistoryEntry: async (id) => {
        try {
          await fetch(`${API_BASE_URL}/sql/history/${id}`, {
            method: 'DELETE'
          });
...
export default useSqlQueryStore;
