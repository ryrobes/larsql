...
2. **Frontend**: `extras/ui/frontend/src/components/`
...
**File**: `extras/ui/frontend/src/components/SoundingsExplorer.js`
...
**File**: `extras/ui/frontend/src/components/SoundingsExplorer.css`
...
- All backend changes go in `extras/ui/backend/app.py` around line 1630 (soundings-tree endpoint)
