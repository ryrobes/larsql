# LARS Semantic SQL + Universal Training - Complete System
...
- `lars/cascade.py` (modified - training fields)
...
**Files:**
- `lars/confidence_worker.py` (180 lines)
- `cascades/semantic_sql/assess_confidence.cascade.yaml` (50 lines)
- `lars/analytics_worker.py` (modified - added confidence queue)
...
**LARS wins on:** Innovation, UX, flexibility, training workflow
...
# Verify
clickhouse-client --database lars --query "SELECT COUNT(*) FROM training_examples_mv"
# Should see: 27081
```
