# LARS Semantic SQL System - Complete Reference
...
**Files:**
- `lars/training_system.py` - Retrieval functions
- `lars/confidence_worker.py` - Auto-scoring
...
| Aspect | LARS Few-Shot Training | PostgresML Fine-Tuning |
|--------|--------------------------|------------------------|
...
**LARS's training is better for most use cases!**
...
LARS introduces a **revolutionary pure-SQL workflow** for embeddings:
...
- `POSTGRESML_VS_LARS.md` - Head-to-head comparison
