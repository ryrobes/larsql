...
A **universal training system** that enables **any LARS cascade** to learn from past successful executions through automatic few-shot learning.
...
**File:** `lars/migrations/create_universal_training_system.sql`
...
**File:** `lars/training_system.py` (NEW - 350 lines)
...
**File:** `lars/runner.py` (MODIFIED - line ~9958)
...
| Feature | LARS Training | PostgresML Fine-Tuning |
|---------|-----------------|------------------------|
...
1. ✅ Apply migration: `lars db init`
...
**Created:**
- `lars/migrations/create_universal_training_system.sql`
- `lars/training_system.py`
...
**Modified:**
- `lars/cascade.py` (added training fields to CellConfig)
- `lars/runner.py` (added training injection at line 9958)
