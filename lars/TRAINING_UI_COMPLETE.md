...
# Or manually:
clickhouse-client --query "$(cat lars/migrations/create_universal_training_system.sql)"
```
...
- [ ] Migration applied (`lars db init`)
...
8. `lars/migrations/create_universal_training_system.sql`
9. `lars/training_system.py`
10. `TRAINING_SYSTEM_QUICKSTART.md`
11. `TRAINING_UI_COMPLETE.md` (this file)

**Modified (6 files):**
1. `lars/cascade.py` - Added training fields to CellConfig
2. `lars/runner.py` - Added training injection logic
