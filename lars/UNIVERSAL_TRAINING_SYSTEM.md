...
### File: `lars/runner.py` (MODIFY)

**Add training example injection before cell execution:**

```python
# In LARSRunner.run_cell() method, before agent invocation
...
### File: `lars/training_system.py` (NEW)

```python
"""
Universal Training System for LARS Cascades
...
**User runs cascade:**
```bash
lars run my_workflow.yaml --input '{"data": "test"}'
```
...
```sql
-- =====================================================
-- Universal Training System for LARS
