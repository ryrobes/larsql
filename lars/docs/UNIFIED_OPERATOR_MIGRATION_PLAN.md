...
LARS's Semantic SQL system has grown organically, resulting in **multiple redundant, hardcoded rewriter systems** that duplicate logic and prevent the "cascades all the way down" philosophy from being fully realized.
