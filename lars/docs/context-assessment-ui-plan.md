...
> A "Bret Victor-style" explorable explanation of context management decisions for the LARS Studio Receipts page.
...
The Context Assessment tab provides a visual, interactive interface for understanding and optimizing context management in LARS cascades. Users can:
  ...
  if (sessions.length === 0) {
    return (
      <div className="context-assessment-panel empty">
        ...
        <p>Run cascades with LARS_SHADOW_ASSESSMENT_ENABLED=true to collect context assessment data.</p>
      </div>
    );
  }
