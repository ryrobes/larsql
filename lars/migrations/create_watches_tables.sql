...
-- ============================================================================
CREATE TABLE IF NOT EXISTS lars.watches
(
    watch_id String,
    name String,
...
ALTER TABLE lars.watches ADD INDEX IF NOT EXISTS idx_watch_name name TYPE bloom_filter GRANULARITY 1;
ALTER TABLE lars.watches ADD INDEX IF NOT EXISTS idx_watch_enabled enabled TYPE set(2) GRANULARITY 1;


-- ============================================================================
-- watch_executions - Execution history and audit trail
-- ============================================================================
CREATE TABLE IF NOT EXISTS lars.watch_executions
(
    execution_id String,
    watch_id String,
    watch_name String,
...
ALTER TABLE lars.watch_executions ADD INDEX IF NOT EXISTS idx_exec_watch_id watch_id TYPE bloom_filter GRANULARITY 1;
ALTER TABLE lars.watch_executions ADD INDEX IF NOT EXISTS idx_exec_status status TYPE set(8) GRANULARITY 1;
ALTER TABLE lars.watch_executions ADD INDEX IF NOT EXISTS idx_exec_cascade_session cascade_session_id TYPE bloom_filter GRANULARITY 1;


-- ============================================================================
-- Materialized View for watch statistics
-- ============================================================================
CREATE MATERIALIZED VIEW IF NOT EXISTS lars.mv_watch_stats
