...
def rewriter():
    ...
    from lars.sql_tools import dimension_rewriter
...
def test_dimension_function_rewrite(test_id, query, func_name):
    ...
    from lars.sql_tools.dimension_rewriter import rewrite_dimension_functions
...
if __name__ == "__main__":
    ...
    print("\nRun with: pytest lars/tests/test_dimension_rewriter.py -v")
