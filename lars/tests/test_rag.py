...
from lars.cascade import RagConfig  # noqa: E402
from lars.rag.indexer import ensure_rag_index  # noqa: E402
from lars.rag.store import list_sources, read_chunk, search_chunks  # noqa: E402


@pytest.fixture(autouse=True)
def deterministic_embeddings(monkeypatch):
    # Force deterministic embeddings for offline, repeatable tests.
    monkeypatch.setenv("LARS_EMBED_BACKEND", "deterministic")
    yield
