...
def test_session_status_enum():
    ...
    from lars.session_state import SessionStatus
...
def test_blocked_type_enum():
    ...
    from lars.session_state import BlockedType
...
def test_session_state_dataclass():
    ...
    from lars.session_state import SessionState, SessionStatus
...
def test_session_state_to_dict():
    ...
    from lars.session_state import SessionState, SessionStatus, BlockedType
...
def test_manager_get_session():
    ...
    from lars.session_state import SessionStateManager
...
def test_manager_set_blocked():
    ...
    from lars.session_state import SessionStateManager, SessionStatus, BlockedType
...
def test_high_level_create_session():
    ...
    import lars.session_state

    # Reset singleton for clean test
    lars.session_state._session_state_manager = None
...
def test_session_state_schema_status_values():
    ...
    from lars.schema import get_schema
