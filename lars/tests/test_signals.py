...
def test_signal_status_enum():
    ...
    from lars.signals import SignalStatus
...
def test_signal_dataclass():
    ...
    from lars.signals import Signal, SignalStatus
...
def test_parse_duration_seconds():
    ...
    from lars.signals import _parse_duration
...
def test_signal_manager_register():
    ...
    from lars.signals import SignalManager, SignalStatus
...
def test_signal_manager_get_signal():
    ...
    from lars.signals import SignalManager
...
def test_high_level_fire_signal():
    ...
    from lars.signals import SignalManager, fire_signal as fire_signal_api, get_signal_manager

    # Reset singleton for clean test
    import lars.signals
    lars.signals._signal_manager = None
...
def test_high_level_list_waiting_signals():
    ...
    from lars.signals import list_waiting_signals, get_signal_manager
...
def test_high_level_cancel_waiting_signal():
    ...
    from lars.signals import cancel_waiting_signal, get_signal_manager
...
def test_fire_signal_tool():
    ...
    from lars.skills.signal_tools import fire_signal
...
def test_list_signals_tool():
    ...
    from lars.skills.signal_tools import list_signals
    from lars.signals import get_signal_manager
...
def test_signals_schema_exists():
    ...
    from lars.schema import get_schema, get_all_schemas
