...
from marimo._server.notebook.serializer import get_format_handler
...
class AppFileManager:
    ...
    def save(self, request: SaveNotebookRequest) -> str:
        ...
        # Note: Don't set layout_file to None when layout is None,
        # as the user may have manually set layout_file in the code
