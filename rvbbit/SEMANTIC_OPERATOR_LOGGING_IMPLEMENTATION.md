...
Instead of a separate `rvbbit_training_examples` table, **log every semantic operator call to ClickHouse** with:
...
5. semantic_sql/registry.py:execute_sql_function() [LINE 316-446]
   ...
   ↓ Line 381-413: Execute cascade via RVBBITRunner
...
### File: `rvbbit/semantic_sql/operator_logger.py` (NEW)
...
### File: `rvbbit/semantic_sql/registry.py` (MODIFY)
...
def mark_calls_trainable():
    ...
    from rvbbit.semantic_sql.operator_logger import mark_as_trainable
...
def test_log_semantic_operator_call():
    ...
    from rvbbit.semantic_sql.operator_logger import log_semantic_operator_call
...
def test_get_training_examples():
    ...
    from rvbbit.semantic_sql.operator_logger import get_training_examples, mark_as_trainable
...
| Aspect | Separate `rvbbit_training_examples` | Unified `semantic_operator_calls` |
|--------|-------------------------------------|-----------------------------------|
