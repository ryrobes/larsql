...
DROP VIEW IF EXISTS rvbbit.mv_sql_query_costs;

-- Create materialized view that aggregates costs by caller_id
CREATE MATERIALIZED VIEW IF NOT EXISTS rvbbit.mv_sql_query_costs
...
-- Verify view exists
-- Run: clickhouse-client --database rvbbit --query "SHOW TABLES LIKE 'mv_sql_query_costs'"
