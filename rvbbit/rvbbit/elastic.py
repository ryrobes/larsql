"""
Elasticsearch adapter for RVBBIT - Hybrid semantic + keyword search
...
def get_elastic_client() -> Elasticsearch:
    ...
    if _es_client is None:
        es_host = os.getenv('RVBBIT_ELASTICSEARCH_HOST', 'http://localhost:9200')
...
def get_index_stats(index_name: str = "rvbbit_sql_schemas") -> Dict[str, Any]:
