"""
Async Embedding Worker for RVBBIT
...
- session_id: "rvbbit_system_embedding"
...
class EmbeddingWorker:
    ...
    def __init__(
        ...
        if enabled is None:
            ...
            enabled = os.getenv("RVBBIT_ENABLE_EMBEDDINGS", "").lower() in ("true", "1", "yes")
    ...
    def start(self):
        ...
        if not self.enabled:
            print("[Embedding Worker] Disabled (set RVBBIT_ENABLE_EMBEDDINGS=true to enable)")
            return
