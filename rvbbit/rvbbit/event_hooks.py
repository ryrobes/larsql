...
Enhanced to include candidate/turn context for proper UI rendering.
Includes auto-save for Research Cockpit sessions.
"""
from datetime import datetime
from typing import Any
from .runner import RVBBITHooks, HookAction
from .events import get_event_bus, Event
import os
import json

class EventPublishingHooks(RVBBITHooks):
    """
    ...
    def on_cascade_start(self, cascade_id: str, session_id: str, context: dict) -> dict:
        ...
        self._current_candidate_index = context.get("candidate_index")
    ...
    def on_cell_start(self, cell_name: str, context: dict) -> dict:
        ...
        # Extract candidate context if available
        candidate_index = context.get("candidate_index") or self._current_candidate_index
...
class CompositeHooks(RVBBITHooks):
    """
    Combines multiple hook implementations.
    Calls all hooks in sequence.
    """

    def __init__(self, *hooks: RVBBITHooks):
        self.hooks = hooks
...
class ResearchSessionAutoSaveHooks(RVBBITHooks):
    """
    ...
    def __init__(self):
        self._auto_save_enabled = os.environ.get('RVBBIT_AUTO_SAVE_RESEARCH', 'true').lower() == 'true'
