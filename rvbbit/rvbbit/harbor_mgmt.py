...
def show_stats():
    ...
    if not stats or stats[0]['total'] == 0:
        console.print("[yellow]No spaces in database. Run 'rvbbit harbor refresh' first.[/yellow]")
        return
...
def wake_space_db(space_id: str):
    ...
    try:
        ...
        console.print("[yellow]Run 'rvbbit harbor refresh' after ~1 minute to update final status[/yellow]")
