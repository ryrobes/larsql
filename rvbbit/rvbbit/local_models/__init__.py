"""
Local Model Tools - HuggingFace transformers integration for RVBBIT.
...
Example usage:
    ...
    # Programmatic:
    from rvbbit.local_models import local_model_tool
...
if is_available():
    ...
    class LocalModelRegistry:
        ...
        def get_or_load(self, *args, **kwargs):
            raise ImportError("transformers/torch not installed. Run: pip install rvbbit[local-models]")
