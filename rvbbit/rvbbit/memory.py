...
class MemorySystem:
    ...
    def __init__(self, memories_dir: Optional[Path] = None):
        ...
        Args:
            memories_dir: Directory for storing memories (defaults to RVBBIT_ROOT/memories)
        """
    ...
    def save_message(
        ...
        Args:
            ...
            metadata: Additional metadata (session_id, cell_name, etc.)
        """
        ...
        entry = {
            ...
            **metadata  # session_id, cascade_id, cell_name, etc.
        }
    ...
    def _update_summary(self, memory_name: str):
        ...
        for msg in sample_messages:
            ...
            cell = msg.get('cell_name', 'unknown')
