...
Usage:
    from rvbbit.rag.smart_search import smart_search_chunks, smart_schema_search
...
Configuration:
    RVBBIT_SMART_SEARCH: Enable/disable smart search (default: true)
    RVBBIT_SMART_SEARCH_MODEL: Model for filtering (default: gemini-2.5-flash-lite)
"""
...
def set_smart_search_enabled(enabled: bool) -> None:
    ...
    os.environ["RVBBIT_SMART_SEARCH"] = "true" if enabled else "false"
