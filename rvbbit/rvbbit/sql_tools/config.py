...
def load_sql_connections() -> Dict[str, SqlConnectionConfig]:
    ...
    clickhouse_port = int(os.getenv("RVBBIT_CLICKHOUSE_PORT", "8123"))  # HTTP port
    clickhouse_database = os.getenv("RVBBIT_CLICKHOUSE_DATABASE", "rvbbit")
    clickhouse_user = os.getenv("RVBBIT_CLICKHOUSE_USER", "rvbbit")
    clickhouse_password = os.getenv("RVBBIT_CLICKHOUSE_PASSWORD", "rvbbit")
