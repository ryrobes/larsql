...
pytest rvbbit/tests/test_semantic_sql_rewrites_dynamic.py -v

# Run discovery summary
python rvbbit/tests/test_semantic_sql_rewrites_dynamic.py

# Run specific operator test
pytest rvbbit/tests/test_semantic_sql_rewrites_dynamic.py -k "means_operator" -v
```
