...
def load_sql_schemas_from_clickhouse():
    ...
    if not meta:
        print("No SQL discovery metadata found. Run: lars sql chart")
        return []
...
def main():
    ...
    # Verify
    from lars.elastic import get_index_stats
    ...
    print()
    print("Test search:")
    print("  curl http://localhost:9200/lars_sql_schemas/_search?pretty")
    print()
