...
def create_artifact_endpoint():
    ...
    try:
        ...
        now = datetime.utcnow()  # Use UTC to match lars backend
...
<body>
    <div class="container">
        ...
        <footer>
            <p>Generated by <a href="https://github.com/lars" target="_blank">LARS</a></p>
            <p style="margin-top: 0.5rem; font-size: 0.8rem;">
                Note: Interactive SQL queries require a running LARS backend
            </p>
        </footer>
    </div>
</body>
...
def export_artifacts_pdf():
    ...
    try:
        ...
        try:
            from lars.screenshot_service import get_screenshot_service
        except ImportError:
