...
def test_phase_config_deterministic_detection():
    """Test that PhaseConfig correctly detects deterministic vs LLM phases."""
    from windlass.cascade import PhaseConfig

    # LLM phase (has instructions)
    llm_phase = PhaseConfig(
        name="llm_phase",
...
def test_phase_config_validation():
    """Test that PhaseConfig validates mutually exclusive fields."""
    from windlass.cascade import PhaseConfig

    # Should fail: neither tool nor instructions
    with pytest.raises(ValueError, match="must have either"):
        PhaseConfig(name="bad_phase")
...
def test_phase_config_with_inputs():
    """Test PhaseConfig with tool_inputs (alias: inputs)."""
    from windlass.cascade import PhaseConfig
...
def test_phase_config_with_routing():
    """Test PhaseConfig with routing configuration."""
    from windlass.cascade import PhaseConfig
...
def test_parse_tool_target_registered():
    ...
    from windlass.deterministic import parse_tool_target
...
def test_render_inputs_basic():
    ...
    from windlass.deterministic import render_inputs
...
def test_determine_routing_with_route_key():
    ...
    from windlass.deterministic import determine_routing
...
def test_parse_timeout():
    ...
    from windlass.deterministic import parse_timeout
...
def test_validate_sql_valid():
    ...
    from windlass.demo_tools import validate_sql
...
def test_transform_data_identity():
    ...
    from windlass.demo_tools import transform_data
...
def test_parse_json_success():
    ...
    from windlass.demo_tools import parse_json
