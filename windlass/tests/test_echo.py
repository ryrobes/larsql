...
from windlass.echo import Echo, SessionManager, get_echo
...
class TestEchoInitialization:
    ...
    def test_internal_state_initialized(self):
        ...
        assert echo._current_phase_name is None
...
class TestContextManagement:
    ...
    def test_set_phase_context(self):
        ...
        echo = Echo(session_id="ctx_test")
        echo.set_phase_context("analysis_phase")
        assert echo._current_phase_name == "analysis_phase"
    ...
    def test_context_enriches_history(self):
        ...
        echo.set_phase_context("test_phase")
        ...
        assert entry["metadata"]["phase_name"] == "test_phase"
...
class TestLineageTracking:
    ...
    def test_add_lineage(self):
        ...
        echo.add_lineage("phase_1", "Output from phase 1", trace_id="trace_1")

        assert len(echo.lineage) == 1
        assert echo.lineage[0]["phase"] == "phase_1"
        assert echo.lineage[0]["output"] == "Output from phase 1"
    ...
    def test_lineage_accumulates(self):
        ...
        phases = [l["phase"] for l in echo.lineage]
...
class TestErrorTracking:
    ...
    def test_add_error(self):
        ...
        assert echo.errors[0]["phase"] == "processing"
...
class TestGetFullEcho:
    ...
    def test_get_full_echo_with_data(self):
        ...
        echo.add_lineage("phase1", "output1")
...
class TestEchoMerging:
    ...
    def test_merge_lineage(self):
        ...
        phases = [l["phase"] for l in parent.lineage]
