...
from windlass import run_cascade, register_tackle, set_provider
...
def test_full_flow():
    ...
    # Check if lineage contains the phases
    phases = [l["phase"] for l in result["lineage"]]
    assert "greeting" in phases
    # Note: Depending on the LLM logic and my simple runner, it might not hit the second phase perfectly
