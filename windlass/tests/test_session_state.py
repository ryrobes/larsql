...
def test_session_status_enum():
    ...
    from windlass.session_state import SessionStatus
...
def test_blocked_type_enum():
    ...
    from windlass.session_state import BlockedType
...
def test_session_state_dataclass():
    ...
    from windlass.session_state import SessionState, SessionStatus
...
def test_session_state_to_dict():
    ...
    from windlass.session_state import SessionState, SessionStatus, BlockedType
...
def test_manager_create_session():
    ...
    from windlass.session_state import SessionStateManager, SessionStatus
...
def test_manager_get_session():
    ...
    from windlass.session_state import SessionStateManager
...
def test_manager_update_status():
    ...
    manager.update_status("session_123", SessionStatus.RUNNING, current_phase="phase_1")
...
def test_manager_update_status_error():
    ...
    assert state.error_phase == "phase_2"


def test_manager_set_blocked():
    """Test setting session to blocked state."""
    from windlass.session_state import SessionStateManager, SessionStatus, BlockedType
...
def test_high_level_create_session():
    ...
    import windlass.session_state

    # Reset singleton for clean test
    windlass.session_state._session_state_manager = None
...
def test_high_level_update_status():
    ...
    update_session_status("api_test_456", SessionStatus.RUNNING, current_phase="phase_1")
...
def test_session_state_schema_exists():
    ...
    from windlass.schema import get_schema, get_all_schemas
