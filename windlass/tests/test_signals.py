...
def test_signal_status_enum():
    ...
    from windlass.signals import SignalStatus
...
def test_signal_dataclass():
    ...
    from windlass.signals import Signal, SignalStatus
    ...
    assert signal.phase_name == "test_phase"
...
def test_parse_duration_seconds():
    ...
    from windlass.signals import _parse_duration
...
def test_signal_manager_register():
    ...
    from windlass.signals import SignalManager, SignalStatus
...
def test_signal_manager_get_signal():
    ...
    from windlass.signals import SignalManager
...
def test_high_level_fire_signal():
    ...
    from windlass.signals import SignalManager, fire_signal as fire_signal_api, get_signal_manager

    # Reset singleton for clean test
    import windlass.signals
    windlass.signals._signal_manager = None
...
def test_high_level_list_waiting_signals():
    ...
    from windlass.signals import list_waiting_signals, get_signal_manager
...
def test_high_level_cancel_waiting_signal():
    ...
    from windlass.signals import cancel_waiting_signal, get_signal_manager
...
def test_fire_signal_tool():
    ...
    from windlass.eddies.signal_tools import fire_signal
...
def test_list_signals_tool():
    ...
    from windlass.eddies.signal_tools import list_signals
    from windlass.signals import get_signal_manager
