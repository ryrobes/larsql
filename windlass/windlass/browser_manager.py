"""
Browser session management for Windlass.
...
class BrowserSessionManager:
    ...
    async def create_session(
        ...
        Args:
            ...
            phase_name: If from cascade, the phase name (for registry)
            windlass_session_id: If from cascade, the windlass session ID (for registry)
