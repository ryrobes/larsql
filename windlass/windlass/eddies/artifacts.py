...
def create_artifact(
    ...
    **Workflow Pattern:**
    ...
    from .state_tools import get_current_session_id, get_current_phase_name, get_current_cascade_id
...
def list_artifacts(
    ...
    if cfg.use_clickhouse_server:
        ...
        result = client.query(f"""
            SELECT id, session_id, cascade_id, phase_name, title, artifact_type,
