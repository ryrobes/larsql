...
def bash_data(
    ...
    Args:
        ...
        input_table: Temp table name to read (default: previous phase = _{prev_phase})
...
export PHASE_NAME='{_phase_name or ""}'
"""
        ...
        if _phase_name and session_db and len(df) > 0:
