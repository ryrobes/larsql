...
def launch_branch_cascade(
    ...
    """
    from ..eddies.research_sessions import get_research_session
    ...
    phase_name = checkpoint_data.get('phase_name', 'research_loop')
    ...
    echo.state[phase_name] = new_response
    ...
    print(f"[Branching] {phase_name}: {new_response}")
