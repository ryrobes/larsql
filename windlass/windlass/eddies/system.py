...
@simple_eddy
def spawn_cascade(cascade_ref: str, input_data: dict = None, parent_trace: Optional[TraceNode] = None) -> str:
    """
    ...
    def worker():
        ...
        try:
            # We use a new runner instance, passing the parent trace
            run_cascade(resolved_cascade_ref, input_data or {}, session_id=session_id, parent_trace=parent_trace)
