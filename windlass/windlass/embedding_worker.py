"""
Async Embedding Worker for Windlass
...
- session_id: "windlass_system_embedding"
...
EMBEDDING_SESSION_ID = "windlass_system_embedding"
...
class EmbeddingWorker:
    ...
    def __init__(
        ...
        if enabled is None:
            ...
            enabled = os.getenv("WINDLASS_ENABLE_EMBEDDINGS", "").lower() in ("true", "1", "yes")
    ...
    def start(self):
        ...
        if not self.enabled:
            print("[Embedding Worker] Disabled (set WINDLASS_ENABLE_EMBEDDINGS=true to enable)")
            return
...
def embed_texts_now(
    ...
    Args:
        ...
        phase_name: Phase name for cost tracking
    ...
    return Agent.embed(
        ...
        phase_name=phase_name or "embed_sync",
    )
