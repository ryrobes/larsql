...
def send_startup_response(sock):
    ...
    sock.sendall(ParameterStatus.encode('server_version', '14.0 (Windlass/DuckDB)'))
...
def send_query_results(sock, result_df):
    """
...
def send_error(sock, message: str, detail: str = None, severity: str = 'ERROR'):
    """
    ...
    sock.sendall(ReadyForQuery.encode('E'))  # Failed transaction state
