...
the Windlass runner can use to track active browser sessions.
...
Usage:
    from windlass.session_registry import SessionRegistry
...
class SessionInfo:
    ...
    windlass_session_id: Optional[str] = None  # The windlass session (parent)
...
class SessionRegistry:
    ...
    Both the dashboard UI and Windlass runner use this to share session info.
    """
    ...
    def __init__(self, root_dir: Optional[str] = None):
        ...
        Args:
            root_dir: Root directory for windlass (defaults to WINDLASS_ROOT or cwd)
        """
        if root_dir:
            self.root_dir = Path(root_dir)
        else:
            # Try to get from windlass config
            try:
                ...
                self.root_dir = Path(os.environ.get('WINDLASS_ROOT', os.getcwd()))
    ...
    def register(
        ...
        cascade_id: Optional[str] = None,
        phase_name: Optional[str] = None,
        windlass_session_id: Optional[str] = None,
        current_url: Optional[str] = None,
        artifacts_path: Optional[str] = None,
        ...
        Args:
            ...
            phase_name: If from cascade, the phase name
            windlass_session_id: If from cascade, the windlass session ID
        ...
        info = SessionInfo(
            ...
            windlass_session_id=windlass_session_id,
