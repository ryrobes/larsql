...
class SessionStateManager:
    ...
    def update_status(
        ...
        Args:
            ...
            status: New status
            current_phase: Current phase name (for running status)
...
def update_session_status(
    ...
    """Update session status."""
    manager = get_session_state_manager()
    manager.update_status(session_id, status, current_phase, error_message, error_phase)
