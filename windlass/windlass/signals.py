"""
Signals System - Cross-Cascade Communication for Windlass.
...
def await_signal(
    ...
    """
    from .eddies.state_tools import get_current_session_id, get_current_cascade_id, get_current_phase_name
