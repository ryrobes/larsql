...
class ToolRegistry:
    def __init__(self):
        self._tackle: Dict[str, Callable] = {}

    def register_tackle(self, name: str, func: Callable):
        self._tackle[name] = func

    def get_tackle(self, name: str) -> Callable:
        return self._tackle.get(name)

    def get_all_tackle(self) -> Dict[str, Callable]:
        return self._tackle

_registry = ToolRegistry()

def register_tackle(name: str, func: Callable):
    _registry.register_tackle(name, func)

def get_tackle(name: str) -> Callable:
    return _registry.get_tackle(name)
...
def register_cascade_as_tool(config_path: str):
    ...
    register_tackle(config.cascade_id, cascade_tool_wrapper)
